...
5. **Ray Montoya (*Anima*, chapter II) has anterograde amnesia.** His TBI (Fallujah, 2004) left him unable to form new long-term memories: **he does not remember José, his physician, from one Thursday session to the next.** The relationship is rebuilt from nothing every week on Ray's side. His presence in the present moment is therefore not a contemplative attainment but a consequence of injury — and the trilogy treats the resemblance to contemplative presence as an open question, not an equivalence. Do not describe Ray's present-moment focus as a "practice" or "discipline" he has cultivated; the user has confirmed the amnesia explicitly.

   **The author's settled position on Ray (confirmed, use this framing):** the same state of presence can be reached by two roads — deliberately, through contemplative practice, or accidentally, through an injury that happens to quiet the same structures. The trilogy's wager is therefore **convergence**: presence is a *condition of the machinery* rather than an achievement of the person, and practice is a method for producing it, not a merit that earns it. Whether the two are the *same* state from the inside is left deliberately open — Ray cannot report comparatively, having no "before" to hold the "after" against, and that inability is part of the difficulty rather than incidental to it. Both `meditation-and-the-receiver.html` §6 and `gnosis-and-the-field.html` have been rewritten to this framing (EN + ES, July 2026).

6. **Indy (the dog in *Anima*) — canonical anticipatory behaviors.** Indy demonstrably anticipates events before any possible sensory cue: he recognises important incoming phone calls before the phone rings, and he goes to the door several minutes before Ciarai's car arrives home. These are the specific behaviors the book establishes; the trilogy treats them as substrate-real signatures of field-coupling, in the conceptual room Sheldrake's animal-anticipation work names.
